...
public class Demo8 {
    public static void main(String[] args) {
        ...
        ArrayList<String> allSubjects2=new ArrayList<>(); //ctl+c to select the complete line
        allSubjects2.addAll(subjectsSeen);
        //insert the data starting from the index 1 and will push thr existing data towards the end
