...
Print out the eID , salary and  CEO for each of the objects
    ...
    String empId;
    int salary;
    // whenever we are sure that two object of a class can have different values for
    // a variables or if we have to share that variable between two or more methods of that
